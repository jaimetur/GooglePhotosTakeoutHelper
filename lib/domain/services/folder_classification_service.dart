...
class FolderClassificationService {
  /// Creates a new folder classification service
  const FolderClassificationService();
...
bool isYearFolder(final Directory dir) =>
    const FolderClassificationService().isYearFolder(dir);

Future<bool> isAlbumFolder(final Directory dir) async =>
    const FolderClassificationService().isAlbumFolder(dir);
